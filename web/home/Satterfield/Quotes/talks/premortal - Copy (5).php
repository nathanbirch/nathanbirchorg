    ...
    <body>
        ...
        <div>
            <main class="container">
                <p align="center"><font size="5" face="Arial">Foreordination</font></p>

                <p style="line-height: 100%; margin-top: 1; margin-bottom: 1">&nbsp;
                <ul>
                    <li>
                        <p style="line-height: 100%; margin-top: 1; margin-bottom: 1"><font face="Arial" size="2">Neal A. Maxwell, <a href="../../Talks/MoreDeterminedNAM.htm">"A More Determined
                                Discipleship"</a>&nbsp;&nbsp;</font></li>
                    <li>
                        <p style="line-height: 100%; margin-top: 1; margin-bottom: 1"><font face="Arial" size="2">Parley P. Pratt, <a href="../../Talks/HeirPriesthoodPPP.htm">&quot;Heirship and
                                Priesthood"</a>
                        </font></li>
                </ul>
                <p align="center">&nbsp;</p>
